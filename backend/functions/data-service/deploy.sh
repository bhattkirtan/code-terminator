...
# Deploy Data Service to Google Cloud Functions
# Run from the data-service directory
...
if [ $? -eq 0 ]; then
    echo "✅ Data Service deployed successfully!"
    ...
    echo "curl -X POST \"$FUNCTION_URL/api/create_project\" \\"
    echo "  -H \"Content-Type: application/json\" \\"
    echo "  -d '{\"projectId\": \"test-project\", \"name\": \"Test Project\"}'"
    echo ""
    echo "🔍 Monitor logs:"
